...
def generate_manifest(manifest,folder_path):
    ...
    for file_name in os.listdir(folder_path):
        ...
        if os.path.isfile(file_path):
            ...
            item =pq( f'<item id="{item_id}" href="html/{file_name}" media-type="{media_type}"/>\n')
...
with open('./toctree.json', 'r', encoding='utf-8') as file:
...
generate_manifest(manifest,'./epub_output/html')
generate_manifest(manifest,'./epub_output/images')
generate_manifest(manifest,'./epub_output/scripts')
generate_manifest(manifest,'./epub_output/style')
